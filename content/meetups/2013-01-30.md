  ...
  - title: Minesweeper CoffeeScript & Dart
    ...
    authors:
      - name: Jean-Laurent Morlhon
        ...
        avatar: 'https://twitter.com/morlhon/profile_image?size=bigger'
      - name: Benoit Lemoine
        url: 'https://twitter.com/benoit_lemoine'
        avatar: 'https://twitter.com/benoit_lemoine/profile_image?size=bigger'
      - name: Mathieu Breton
        url: 'https://twitter.com/MatBreton'
        avatar: 'https://twitter.com/MatBreton/profile_image?size=bigger'
    slides: []
    links: []
    videos: []
